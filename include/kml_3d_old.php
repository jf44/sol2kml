...
';
				...
				if ($fichier_dae!=''){
					// recopier le fichier modele
					// recopier_modele_complet_dae($dossier_3d, $fichier_dae, $nom_bato, $voile, $dossier_type, $bord, $modele)
					if (recopier_modele_complet_dae($dossier_3d, $fichier_dae, $bato->nom, GetNomVoile($bato->voile), $bato->type, $bord, $modele)){
						$s.='			<Link id="'.$bato->nom.'">
...
//------------------------
function recopier_modele_complet_dae($dossier_3d, $fichier_dae, $nom_bato, $voile, $dossier_type, $bord, $modele){
...
<Folder>
    ...
    <ScreenOverlay>
		<name>'.$coursename.' ('.$coursenumber.')</name>
		<Icon>
			<href>'.$url.'</href>
		</Icon>
